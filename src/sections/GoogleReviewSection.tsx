    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-md"
        >
        ...
        {/* Stars with staggered spring reveals */}
        <motion.div
          variants={{
            hidden: {},
            visible: {
        ...
        >
          {[1, 2, 3, 4, 5].map((s) => (
            <motion.div
              ...
              style={{ animationDelay: `${(s - 1) * 0.35}s` }}
            >
              <Star size={24} className="text-[#F5C542]" fill="#F5C542" />
            </motion.div>
          ))}
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-3 text-sm sm:text-base leading-relaxed text-white/65 max-w-md mx-auto"
        >
        ...
        <motion.p
          ...
          className="mt-3 text-xs text-white/40 tracking-wide"
        >
        ...
        >
          <motion.a
            ...
            className="btn-shimmer btn-glow inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#F5C542] to-[#FFD86B] px-7 py-3 text-sm font-semibold text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F5C542]/70 cursor-pointer"
          >
